  ...
  const services = [
    {
      ...
      description: 'End-to-end web applications with cutting-edge technologies and scalable architecture.'
    },
    {
      title: '3D ANIMATION',
      description: 'Immersive 3D experiences, motion graphics, and stunning visual storytelling.'
    },
    {
      title: 'GRAPHIC DESIGN',
      description: 'Bold visual identities, print materials, and digital assets that make an impact.'
    },
    {
      title: 'UI/UX DESIGN',
      description: 'User-centered interfaces that blend aesthetics with exceptional functionality.'
    },
    {
      title: 'VIDEO EDITING',
      description: 'Complete brand strategies from logo design to comprehensive brand guidelines.'
    }
  ];

  return (
    <section ref={sectionRef} id="services" className="py-32 bg-zinc-950">
